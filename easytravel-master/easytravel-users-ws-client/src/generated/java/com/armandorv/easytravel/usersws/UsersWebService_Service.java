 ...
 * 2013-07-01T22:53:35.450+02:00
 * Generated source version: 2.7.3
 * 
 */
@WebServiceClient(name = "UsersWebService", 
                  wsdlLocation = "http://userseasytravel.cfapps.io/services/UsersWebService?wsdl",
...
public class UsersWebService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://userseasytravel.cfapps.io/services/UsersWebService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UsersWebService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://userseasytravel.cfapps.io/services/UsersWebService?wsdl");
        }
        WSDL_LOCATION = url;
    }
