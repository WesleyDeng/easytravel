package com.armandorv.easytravel.web.infrastructure.security;
...
public class GoogleOpenIdAttributesBuilder {

	private Set<String> emailAddressAttributeNames = new HashSet<>();
	private Set<String> firstNameAttributeNames = new HashSet<>();
	private Set<String> lastNameAttributeNames = new HashSet<>();
	private Set<String> fullNameAttributeNames = new HashSet<>();

	public GoogleOpenIdAttributes build(OpenIDAuthenticationToken openIdAuthenticationToken) {
		...
		return new GoogleOpenIdAttributes(userLocalIdentifier, emailAddress, fullName, 
				loginReplacement);
	}
